...
public class SpindleVisualizationPanel extends JPanel {
    ...
    private int maintenancePrediction; // 1 = maintenance needed, 0 = no maintenance
    ...
    public void updateVisualization(double vibration, double temperature, double power, double load, 
                                  double bearingLife, double spindleLife, double wheelWear, int maintenancePrediction) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.drawString("Bearing Life: " + String.format("%.0f h", bearingLife), 
            bearingGaugeX, bearingGaugeY + gaugeSize + 10);
        ...
        g2d.drawString("Spindle Life: " + String.format("%.1f%%", spindleLife * 100), 
            spindleGaugeX, spindleGaugeY + gaugeSize + 40);
        ...
        int statusX = spindleX + spindleWidth / 2 - 15;
        int statusY = spindleY + spindleHeight + 20;
        g2d.setColor(maintenancePrediction == 1 ? Color.RED : Color.GREEN);
        g2d.fillOval(statusX, statusY, 30, 30);
        g2d.setColor(Color.WHITE);
        g2d.setFont(new Font("Dialog", Font.PLAIN, 14));
        g2d.drawString("Maintenance: " + (maintenancePrediction == 1 ? "Needed" : "OK"), 
            statusX - 20, statusY + 50);
    }
